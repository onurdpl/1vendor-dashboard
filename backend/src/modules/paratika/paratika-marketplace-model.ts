...
export type ParatikaMarketplaceModelName =
  ...
  | 'seller_commission_amount_based'
  | 'seller_commission_rate_based';

export const DEFAULT_PARATIKA_MARKETPLACE_MODEL: ParatikaMarketplaceModel = 'SELLER_PAYMENT_AMOUNT';
...
export function paratikaMarketplaceModelName(model: ParatikaMarketplaceModel): ParatikaMarketplaceModelName {
  switch (model) {
    case 'SELLER_COMMISSION_AMOUNT':
      return 'seller_commission_amount_based';
