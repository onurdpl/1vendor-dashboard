...
- Successful refund money movement does not imply full customer refund completion. The Admin Order projection separately classifies canonical order-level customer money as partial, full, or unresolved; this classification does not change the refund adjustment or vendor finance formulas in this document.
